...
from BlockchainState import BlockchainState, verify_reorg
...
class Node(ThreadingActor):
        ...
        if blocks[0].height == height:
            ...
            for block in blocks:
                try:
                    ...
                    print("Block", block.block_id.hex(),
    ...
    def received_transactions(self, transactions: List[Transaction]):
        ...
        for transaction in transactions:
            try:
                sender_state = self.blockchain_state.user_states.get(
                    transaction.sender_hash)
